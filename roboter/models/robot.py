...
DEFULT_ROBOT_NAME = 'Roboko'


class Robot(object):
    """Base model for Robot."""

    def __init__(self, name=DEFULT_ROBOT_NAME, user_name='', speak_color='green'):
        self.name = name
...
class RestaurantRobot(Robot):
    ...
    def __init__(self, name=DEFULT_ROBOT_NAME):
    ...
    @_hello_decorator
    def thank_you(self):
        """show words of appreciation to user."""
